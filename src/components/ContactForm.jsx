...
const ContactForm = () => {
  ...
  return (
    <div className="bg-black text-white py-12 px-6 sm:px-10 lg:px-16">
      <div className="max-w-lg mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="telefono" className="block text-white font-bold mb-2">Teléfono (Opcional)</label>
            <input
              type="tel"
              id="telefono"
              name="telefono"
